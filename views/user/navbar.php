...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'cancel') {
    ...
    $conn->query("UPDATE appointments SET status='cancelled'
                  WHERE id=$apptId AND customer_id=$customerId AND status IN ('pending','confirmed')");
}
  ...
  <div class="container">
    ...
    <div class="my-account-header mb-4">
      ...
      <div class="d-flex gap-2 flex-wrap">
        ...
        <a href="<?= BASE_PATH ?>views/user/logout.php" class="btn-outline-dark">
